...
MapGroup_EmeraldTown:
	table_width MAP_LENGTH, MapGroup_EmeraldTown
	map EmeraldTown, TILESET_JOHTO, ROUTE, LANDMARK_NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	assert_table_length NUM_EMERALDTOWN_MAPS